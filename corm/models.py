...
class Project(models.Model):
    ...
    tag = models.ForeignKey(Tag, related_name='projects_by_content', on_delete=models.SET_NULL, null=True, blank=True, help_text='Any content with this tag will be included in this project\'s activity')
    member_tag = models.ForeignKey(Tag, related_name='projects_by_member', on_delete=models.SET_NULL, null=True, blank=True, help_text='Any activity by a member with this tag will be included in this project\'s activity')
