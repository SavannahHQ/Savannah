...
class SourceAdmin(admin.ModelAdmin):
    list_display = ("name", "server", "connector", "community", "contact_count", "activity_count", "conversation_count")
...
class ConversationAdmin(admin.ModelAdmin):
    list_display = ("channel", "timestamp", "link", "participant_list")
    list_filter = ("channel__source__community", "channel__source__connector", "tags", "participants")
